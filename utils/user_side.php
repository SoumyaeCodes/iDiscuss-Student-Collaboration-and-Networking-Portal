          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  <li class="nav-item">
                      <a href="http://localhost/iwp/user_profile/home.php" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="http://localhost/iwp/user_profile/category.php" class="nav-link">
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="http://localhost/iwp/user_profile/datatable_que_thread.php" class="nav-link">
                                  <i class="nav-icon fas fa-circle"></i>
                                  <p>Question Threads</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="http://localhost/iwp/user_profile/datatable_ans_thread.php" class="nav-link">
                                  <i class="nav-icon fas fa-circle"></i>
                                  <p>Answer Threads</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              ...
                              <ul class="nav nav-treeview">
                                  <li class="nav-item" id="ld_hover">
                                      <a href="http://localhost/iwp/user_profile/datatable_que_like.php" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Likes</p>
                                      </a>
                                  </li>
                                  <li class="nav-item" id="ld_hover">
                                      <a href="http://localhost/iwp/user_profile/datatable_que_dislike.php" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Dislikes</p>
                                      </a>
                                  </li>
                          ...
                          <li class="nav-item">
                              ...
                              <ul class="nav nav-treeview">
                                  <li class="nav-item" id="ld_hover">
                                      <a href="http://localhost/iwp/user_profile/datatable_ans_like.php" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Likes</p>
                                      </a>
                                  </li>
                                  <li class="nav-item" id="ld_hover">
                                      <a href="http://localhost/iwp/user_profile/datatable_ans_dislike.php" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Dislikes</p>
                                      </a>
                                  </li>
                  ...
                  <li class="nav-item">
                      <a href="http://localhost/iwp/user/update_profile.php" class="nav-link">
