                                            ...
                                            while($row1=mysqli_fetch_assoc($result_comment_id))
                                            {
                                                ...
                                                while($row1=mysqli_fetch_assoc($sql_post_id))
                                                {
                                                    ...
                                                    while($row1=mysqli_fetch_assoc($sql_que_title))
                                                    {
                                                        ...
                                                        $sql_ans_like="SELECT COUNT(rating_action) as `likerate`, `comment`, `comment_sender_name` FROM `rating_info`,`tbl_comment` WHERE `comment_id`=$comment_id AND rating_action='like' AND rating_info.post_id=tbl_comment.comment_id";
