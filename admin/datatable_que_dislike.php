...
<head>
    ...
    <title>Question Dislike Table</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Question Dislike Table</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="http://localhost/iwp/admin/home.php">Home</a></li>
                                <li class="breadcrumb-item active">Question Dislike Table</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="users" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <?php $sql_post_id="SELECT `S.NO` FROM `questions`";
                                            $result_post_id=mysqli_query($conn, $sql_post_id);
                                            while($row=mysqli_fetch_assoc($result_post_id))
                                            {
                                                $post_id=$row['S.NO'];

                                                $sql_q_like="SELECT COUNT(rating_action) as `dislikerate`, `Question title`, `Question Description`, `Category`, `Tags`, `Asked By` FROM `rating_info`,`questions` WHERE `post_id`=$post_id AND questions.`S.NO`=rating_info.post_id AND rating_action='dislike'";
